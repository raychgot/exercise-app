...
const exercises = [
  { name: "Push Ups", type: "repetition", description: "Get stronger with every rep", icon: PushUpsIcon,},
  { name: "Running", type: "duration", description: "Improve your stamina", icon: RunningIcon,},
  { name: "Plank", type: "duration", description: "Build core strength", icon: PlankIcon,},
];
